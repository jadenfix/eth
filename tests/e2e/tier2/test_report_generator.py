...
- Project: sunny-strategy-461219-t8 ✅
- Dataset: onchain_data ✅
- Tables observed in console: curated_events ✅, raw_data ✅
- Environment configuration: raw_events ✅, curated_events ✅
...
- ✅ curated_events: Exists in both console and .env
- ✅ raw_data: Exists in console, added to .env as BIGQUERY_TABLE_RAW_DATA
- ✅ raw_events: Configured in .env (BIGQUERY_TABLE_RAW)
...
1. **Bidirectional Graph Sync:** ✅ Operational (Neo4j-based)
2. **ZK-Attested Signals:** ✅ Operational (cryptographic workflow)  
3. **Gemini Explainer:** 🔧 Needs Vertex AI access
4. **Autonomous Actions:** 🔧 Needs BigQuery write permissions
5. **Voice Operations:** ✅ Operational (ElevenLabs + Neo4j)
